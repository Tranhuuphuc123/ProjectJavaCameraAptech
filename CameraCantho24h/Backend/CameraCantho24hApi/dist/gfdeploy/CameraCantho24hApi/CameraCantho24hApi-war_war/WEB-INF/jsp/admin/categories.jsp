...
<!--náº¡p giao diá»n chÃ­nh cá»§a nhá»¯ng layout cá» Äá»nh mÃ  mÃ¬nh tÃ¡ch riÃªng á» má»¥c
tags/layouts  (trÃ¡nh viáº¿t Äi viáº¿t láº¡i nhÆ° bÃªn vscode lÃ m giao diá»n thá»§ cÃ´ng)-->
...
<layout:admin_layout>
    ...
    <jsp:attribute name="styles">
        <!--chÃ¨n css cÃ¡ nhÃ¢n vÃ o ÄÃ¢y-->
    </jsp:attribute>
    
    <jsp:attribute name="scripts">
        <script src="${pageContext.request.contextPath}/resources/admin/js/categories.js"></script>
    </jsp:attribute>

    <jsp:body>
        <!--chÃ¨n source cá»§a categories form vÃ o boddy thay tháº¿ luÃ¢n phiÃªn cá»§a admin layout-->
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <form id="create-form" class="p-4 md:p-5">
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            ...
                            <div class="col-span-2 form-gr">
                                <label for="cateName" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">CategoryName</label>
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <form id="update-form" class="p-4 md:p-5">
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            <div class="form-gr">
                                <input type="hidden" name="cateID" id="cateIDEdit">
                                <span class="text-base font-normal text-red-500 mt-1 form-message"></span>
                            </div>
                            <div class="col-span-2">
                            ...
                            <div class="col-span-2 form-gr">
                                <label for="imageEdit" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Upload image</label>
                            ...
                            <div class="col-span-2 form-gr">
                                <label for="cateNameEdit" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">CategoryName</label>
                                <input type="text" name="cateName" id="cateNameEdit"Edit class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                <span class="text-base font-normal text-red-500 mt-1 form-message"></span>
                            </div>
                            <div class="col-span-2 form-gr">
                                <label for="descriptionEdit" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Description</label>
                                <input type="text" name="description" id="descriptionEdit"Edit class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                <span class="text-base font-normal text-red-500 mt-1 form-message"></span>
                            </div>
                        </div>
                        <div class="flex justify-end items-center">
        ...
        <div class="mb-4">
            <h1 class="font-semibold text-3xl text-gray-800">Categories management</h1>
